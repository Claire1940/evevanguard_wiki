...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.evevanguard.wiki'

// 内容类型优先级配置（依据 navigation.ts 的 6 个 EVE Vanguard 内容类型）
...
// 内容更新频率配置（release/access 为时效性内容 daily，guide/gameplay weekly，connection/platforms monthly）
