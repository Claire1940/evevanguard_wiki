...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - EVE Vanguard Wiki',
    description: 'Copyright and intellectual property information for EVE Vanguard Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - EVE Vanguard Wiki',
      description: 'Copyright and intellectual property information for EVE Vanguard Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 EVE Vanguard Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of EVE Vanguard Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              EVE Vanguard Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform (Valve Corporation)</li>
              <li><strong>CCP Games</strong> - Developers of the EVE Vanguard game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Warclone names and abilities</li>
              <li>In-game weapons, loadouts, and mechanics</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>EVE Vanguard</strong> - Trademark of CCP Games</li>
              <li><strong>EVE Vanguard Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with EVE Vanguard Wiki.
            </p>
            ...
            <p>
              ...
              EVE Vanguard Wiki<br />
              Email: <a href="mailto:dmca@evevanguard.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@evevanguard.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "EVE Vanguard Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: EVE Vanguard Wiki (evevanguard.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@evevanguard.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@evevanguard.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@evevanguard.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@evevanguard.wiki</a>
            </p>
            <p>
