...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - EVE Vanguard Wiki",
    description: "Read the Terms of Service for EVE Vanguard Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - EVE Vanguard Wiki",
      description: "Terms and conditions for using EVE Vanguard Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using EVE Vanguard Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using EVE Vanguard Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and EVE Vanguard Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              EVE Vanguard Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "EVE Vanguard". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date and playtest coverage</li>
              <li>Weapons and loadout guides</li>
              <li>Extraction and survival strategies</li>
              <li>Maps and battlefield information</li>
              <li>PC specs and system requirements</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> EVE Vanguard Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or CCP Games, the official developers of EVE Vanguard. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by EVE Vanguard Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or CCP Games, the developers of EVE Vanguard. We use such
            ...
            <ul>
              ...
              <li><strong>Playtest Availability:</strong> Alpha playtest windows and release timelines may change without notice. We are not responsible for playtest access or schedule changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, EVE VANGUARD WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and EVE Vanguard Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@evevanguard.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@evevanguard.wiki</a>
            </p>
            <p>
